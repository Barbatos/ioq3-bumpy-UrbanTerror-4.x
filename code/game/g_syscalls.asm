...
equ trap_Parse_AddGlobalDefine      -47
equ trap_Parse_LoadSource           -48
equ trap_Parse_FreeSource           -49
equ trap_Parse_ReadToken            -50
equ trap_Parse_SourceFileAndLine    -51

equ trap_SendGameStat               -52
equ trap_DemoCommand                -53
