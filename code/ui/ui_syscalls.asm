...
equ trap_CrosshairPlayer              -89
equ trap_LastAttacker                 -90
equ trap_Parse_AddGlobalDefine        -91
equ trap_Parse_LoadSource             -92
equ trap_Parse_FreeSource             -93
equ trap_Parse_ReadToken              -94
equ trap_Parse_SourceFileAndLine      -95
