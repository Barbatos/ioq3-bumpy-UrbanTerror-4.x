...
equ trap_GetDemoState					-113
equ trap_GetDemoPos						-114
equ trap_GetDemoName					-115
equ trap_Key_KeynumToStringBuf			-116
equ trap_Key_GetBindingBuf				-117
equ trap_Key_SetBinding					-118
equ trap_S_SoundDuration				-119
equ trap_Parse_AddGlobalDefine			-120
equ trap_Parse_LoadSource				-121
equ trap_Parse_FreeSource				-122
equ trap_Parse_ReadToken				-123
equ trap_Parse_SourceFileAndLine		-124
