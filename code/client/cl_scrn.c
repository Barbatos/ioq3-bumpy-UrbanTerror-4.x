...
void SCR_DrawConsoleFontChar( float x, float y, int ch )
{
    ...
    yadj = glyph->top;
    xadj = (SCR_ConsoleFontCharWidth( ch ) - glyph->xSkip) / 2.0;
...
void SCR_DrawVoipSender( void ) {
	...
	{
		if (cls.voipTime[i] > cls.realtime)
		{
			playerName = Info_ValueForKey(cl.gameState.stringData +
			...
			{
				case TEAM_RED: teamColor = 1; break;
				case TEAM_BLUE: teamColor = 4; break;
				default: teamColor = 7;
			}
			...
			{
				case 0:
					SCR_DrawStringExt(320 - strlen( playerName ) * -8, 365 + i*4, 8, playerName, g_color_table[teamColor], qtrue, qfalse);
					break;
				case 1:
					SCR_DrawStringExt(320 - strlen( playerName ) * 17, 365 + i*4, 8, playerName, g_color_table[teamColor], qtrue, qfalse);
					break;
				case 2:
					SCR_DrawStringExt(320 - strlen( playerName ) * -9, 100 + i*4, 8, playerName, g_color_table[teamColor], qtrue, qfalse);
					break;
				case 3:
					SCR_DrawStringExt(320 - strlen( playerName ) * 4, 30 + i*4, 8, playerName, g_color_table[teamColor], qtrue, qfalse);
					break;
				case 4:
					SCR_DrawStringExt(320 - strlen( playerName ) * 4, 400 + i*4, 8, playerName, g_color_table[teamColor], qtrue, qfalse);
					break;
				case 5:
				default:
					SCR_DrawStringExt(320 - strlen( playerName ) * -8, 380 + i*4, 8, playerName, g_color_table[teamColor], qtrue, qfalse);
					break;
			}
		}
	}
