...
#define QKEY_FILE_FALLBACK "baseq3/qkey"
...
#ifdef USE_VOIP
	int			voipTime[MAX_CLIENTS];		// time for a voice to be active for a player
#endif
...
extern  cvar_t  *cl_redConfig;
extern  cvar_t  *cl_blueConfig;
